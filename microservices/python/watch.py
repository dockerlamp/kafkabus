...
while True:
    ...
    if now_modify > last_modified:
        ...
        killme(process.pid)
        # del and recover file been modified (using tmp copy)
        #tmp_name = '.'+script_abs_path
        #shutil.copyfile(script_abs_path, tmp_name)
        #shutil.copyfile(tmp_name, script_abs_path)
